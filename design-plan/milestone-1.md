...
The organization closely reflects how the target audience approaches evaluating candidates: career interests and education are visible right away on the home page, projects are centralized on a dedicated page to help assess technical fit, and personal interests and involvement are grouped separately to highlight cultural fit and candidate profile differentiation. I initially had community involvement (leadership, volunteering, etc.) on its own page, but merging it with personal content felt more intuitive from the audience’s perspective and better reflected its role in the hierarchy of content (some recruiters might want to skip it entirely, so it made sense to put it in personal).
